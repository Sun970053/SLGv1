...
void ds1307_set_current_date(RTC_date_t* rtc_date)
{
	...
	DS1307_write_reg_byte(DS1307_ADDR_DATE, rtc_date->date);
	DS1307_write_reg_byte(DS1307_ADDR_MONTH, rtc_date->month);
	DS1307_write_reg_byte(DS1307_ADDR_YEAR, rtc_date->year);
}
...
void ds1307_get_current_date(RTC_date_t* rtc_date)
{
	...
	rtc_date->year = bcd2binary(DS1307_read_reg_byte(DS1307_ADDR_MONTH));
}
